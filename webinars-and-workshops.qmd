...
_In this webinar we will go under the hood of The Strategy Unit's renal model (Kidney-SCOPE). We will explore how alongside, Midlands Kidney Network, we were able to built a model that considers demand for kidney services across the entire kidney pathway and allows interventions to be explored in a risk-free environment._
