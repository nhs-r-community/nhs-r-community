...
format:
  html:
    code-fold: true
---
![](img/PST-Blog-PositronforProductOwners-A.jpg){fig-alt="A data scientist working and an inset of the Positron IDE"}
...
![](img/image1-391x1024.png){fig-alt="Screenshot of the Positron IDE Source Control panel" width="300"}
...
![](img/image2.png){fig-alt="Screenshot of the Positron IDE showing a Quarto document"}
...
![](img/image3.png){fig-alt="Screenshot of the Positron IDE plotting pane"}
...
![](img/image4.png){fig-alt="Screenshot of the Positron IDE testing pane" width="300"}
...
![](img/image5.jpg){fig-alt="Screenshot of the Positron IDE Extension Marketplace" width="300"}
...
![](img/image6.png){fig-alt="Screenshot of the Positron settings.json file"}

![](img/Untitled-design.gif){fig-alt="Animation showing the use of multicursor functionality" width="300"}
