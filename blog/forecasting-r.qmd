...
<<<<<<< Updated upstream
<<<<<<< Updated upstream
author: Bahman Rostrami-Tabar
=======
author: Bahman Rostami-Tobar
>>>>>>> Stashed changes
=======
author: Bahman Rostami-Tobar
>>>>>>> Stashed changes
...
- Basic knowledge in statistics is assumed, for example “I know what normal distribution is”;
- Basic knowledge of R is assumed, for example “I know what data type and data structure is”, “I know how to use a function”;
...
The blog has been edited for [NHS-R Style](https://nhsrway.nhsrcommunity.com/style-guides.html#referencing-r-packages-and-functions-in-text) and formatted to remove [Latin Abbreviations](https://nhsrway.nhsrcommunity.com/style-guides.html#avoid-latin-abbreviation)
