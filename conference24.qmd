...
We will be using a dedicated conference channel on Slack to take questions for our speakers. Last year this allowed both in-person and virtual attendees to ask questions and prompted discussions that lasted beyond the conference. 

A link to join the NHS-R community Slack channel can be found in our [postcard](https://postcard.nhsrcommunity.com/).
...
tibble::tribble(
  ...
  "15:55 – 16:05", "Community Talk -NHS.Pycom", "To be confirmed",
